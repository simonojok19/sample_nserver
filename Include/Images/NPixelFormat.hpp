...
public:
	...
	NPixelFormat GetIndexed(NInt bitsPerIndex)
	{
		...
		NCheck(NPixelFormatGetIndexed(this->value, bitsPerIndex, &nPixelFormat));
		return NPixelFormat(nPixelFormat);
	}

	NPixelFormat GetNonIndexed()
	{
		NPixelFormat_ nPixelFormat;
		NCheck(NPixelFormatGetNonIndexed(this->value, &nPixelFormat));
		return NPixelFormat(nPixelFormat);
	}
	...
	{
		NPixelFormat_ nPixelFormat;
		NCheck(NPixelFormatGetSeparated(this->value, &nPixelFormat));
		return NPixelFormat(nPixelFormat);
	}
	...
	{
		NPixelFormat_ nPixelFormat;
		NCheck(NPixelFormatGetNonSeparated(this->value, &nPixelFormat));
		return NPixelFormat(nPixelFormat);
	}
	...
	{
		NPixelFormat_ nPixelFormat;
		NCheck(NPixelFormatGetWithExtraChannel(this->value, extraChannel, &nPixelFormat));
		return NPixelFormat(nPixelFormat);
	}
	...
	{
		NSizeType nSizeType;
		NCheck(NPixelFormatGetRowSize(this->value, length, alignment, &nSizeType));
		return nSizeType;
	}
	...
	{
		NSizeType nSizeType;
		NCheck(NPixelFormatGetPaletteSize(this->value, length, &nSizeType));
		return nSizeType;
	}
