#ifndef WX_ABOUT_BOX_HPP_INCLUDED
#define WX_ABOUT_BOX_HPP_INCLUDED
...
private:
	void InitGUI(const wxString& productNameString, const wxString& versionString, const wxString& copyrightString)
	{
		...
		sizerRight->Add(activated, 1, wxALL | wxEXPAND, 1);
		...
		sizerBottom->Add(buttonOK, 0, wxALL, 5);
...
#endif // !WX_ABOUT_BOX_HPP_INCLUDED
