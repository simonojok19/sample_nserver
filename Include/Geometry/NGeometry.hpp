...
class NPoint3F : public NPoint3F_
{
	N_DECLARE_STRUCT_CLASS(NPoint3F)

public:
	NPoint3F(NFloat x, NFloat y, NFloat z)
	{
		X = x;
		Y = y;
		Z = z;
...
N_DEFINE_STRUCT_TYPE_TRAITS(Neurotec::Geometry, NPoint3F)
