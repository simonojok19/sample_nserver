...
public:
	...
	{
		HNValue hnKey;
		NCheck(NObjectGet(this->hKey, (HNObject *)&hnKey));
		return NObject::FromHandle<NValue>(hnKey, true);
	}
	...
	{
		HNValue hnValue;
		NCheck(NObjectGet(this->hValue, (HNObject *)&hnValue));
		return NObject::FromHandle<NValue>(hnValue, true);
	}
