...
NResult N_API NEAttributesGetCropRect(HNEAttributes hAttributes, struct NRect_ * pValue);
NResult N_API NEAttributesSetCropRect(HNEAttributes hAttributes, const struct NRect_ * pValue);
...
NResult N_API NEAttributesGetNoCosmeticLensesConfidence(HNEAttributes hAttributes, NByte * pValue);
NResult N_API NEAttributesSetNoCosmeticLensesConfidence(HNEAttributes hAttributes, NByte value);
