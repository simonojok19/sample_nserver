...
#define NFR_MAX_QUALITY_BLOCK_COUNT     255
...
NResult N_API NFRecordGetQualityBlockCount(HNFRecord hRecord, NInt * pValue);
NResult N_API NFRecordGetQualityBlock(HNFRecord hRecord, NInt index, struct NBiometricQualityBlock_ * pValue);
NResult N_API NFRecordSetQualityBlock(HNFRecord hRecord, NInt index, const struct NBiometricQualityBlock_ * pValue);
NResult N_API NFRecordGetQualityBlocks(HNFRecord hRecord, struct NBiometricQualityBlock_ * * parValues, NInt * pValueCount);
NResult N_API NFRecordGetQualityBlockCapacity(HNFRecord hRecord, NInt * pValue);
NResult N_API NFRecordSetQualityBlockCapacity(HNFRecord hRecord, NInt value);
NResult N_API NFRecordAddQualityBlock(HNFRecord hRecord, const struct NBiometricQualityBlock_ * pValue, NInt * pIndex);
NResult N_API NFRecordInsertQualityBlock(HNFRecord hRecord, NInt index, const struct NBiometricQualityBlock_ * pValue);
NResult N_API NFRecordRemoveQualityBlockAt(HNFRecord hRecord, NInt index);
NResult N_API NFRecordClearQualityBlocks(HNFRecord hRecord);
