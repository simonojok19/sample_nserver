...
public:
	...
	public:
		...
		{
			NInt value;
			NCheck(FmrFingerViewGetMinutiaFourNeighborCount(this->GetOwnerHandle(), baseIndex, &value));
			return value;
		}
	...
	public:
		...
		{
			NInt value;
			NCheck(FmrFingerViewGetMinutiaEightNeighborCount(this->GetOwnerHandle(), baseIndex, &value));
			return value;
		}
...
public:
	...
	{
		NUShort value;
		NCheck(FmrFingerViewGetHorzScanResolution(GetHandle(), &value));
		return value;
	}

	void SetHorzScanResolution(NUShort value)
	{
		NCheck(FmrFingerViewSetHorzScanResolution(GetHandle(), value));
	}

	NUShort GetVertScanResolution() const
	{
		NUShort value;
		NCheck(FmrFingerViewGetVertScanResolution(GetHandle(), &value));
		return value;
	}

	void SetVertScanResolution(NUShort value)
	{
		NCheck(FmrFingerViewSetVertScanResolution(GetHandle(), value));
	}
