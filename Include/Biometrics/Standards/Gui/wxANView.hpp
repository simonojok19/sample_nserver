#ifndef WX_ANVIEW_HPP_INCLUDED
#define WX_ANVIEW_HPP_INCLUDED
...
public:
	...
	wxANView(wxWindow *parent, wxWindowID winid = wxID_ANY)
		: wxNView(parent, winid), _record(NULL, false), _type8Record(NULL, false), _type9Record(NULL, false), _type14Record(NULL, false), _bitmap(), _imageError((HNError)NULL)
	{
		_sx = 0;
		_sy = 0;
		_w = 0;
