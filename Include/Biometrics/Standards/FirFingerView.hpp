...
public:
	N_DEPRECATED("function is deprecated, use FIRecord constructor and Add() or Add(BdifFPPosition, const ::Neurotec::IO::NBuffer) or Add(BdifFPPosition, BdifScaleUnits, NUShort, NUShort, NByte, FirImageCompressionAlgorithm, const ::Neurotec::Images::NImage) instead")
