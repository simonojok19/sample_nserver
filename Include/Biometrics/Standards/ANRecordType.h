...
NResult N_API ANRecordTypeGetType20Ex(HANRecordType * phValue);
NResult N_API ANRecordTypeGetType21Ex(HANRecordType * phValue);
...
NResult N_API ANRecordTypeGetFieldXmlElementN(HANRecordType hRecordType, NVersion_ version, NInt fieldNumber, HNString * phValue);
